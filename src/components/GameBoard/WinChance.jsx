...
export default function WinChance({ win_chance, game_state }) {
  const player_ind = win_chance.player_ind !== -1 ? win_chance.player_ind : 1;
  const win_prob = win_chance.win_chance !== null ? win_chance.win_chance : 0.5;
  ...
  return (
    <div className="win-chance">
      <div className="win-chance-section">
        <div className="win-chance-label">
          Win Chance
          <div
            className={`loader ${
              win_chance.calculation_ongoing ? "active" : ""
            }`}
          ></div>
        </div>
        <div className="player-win-stats">
          <div className={`player-win-info ${active === 1 ? "active" : ""}`}>
            <div className="name">Player 1 :</div>
            <div className="win-percent">
              {Math.round(player1_win_chance * 100)}%
            </div>
          </div>

          <div className={`player-win-info ${active === 2 ? "active" : ""}`}>
...
//       <div
//         id="player1-name"
//         className={`player-name ${active === 1 ? "active" : ""}`}
//       >
//         Player 1
//       </div>
//       <div
...
//       <div
//         id="player2-name"
//         className={`player-name ${active === 2 ? "active" : ""}`}
//       >
//         Player 2
//       </div>
//       <div
